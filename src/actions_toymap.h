 ...
 */
class PTIso: public BasePointTransform{
 ...
 */
class PTHarm : public BasePointTransform{
    ...
    PTIso interpPTIso(double x, const PTIso&, const PTIso&);
    PTHarm interpPTHarm(double x, const PTHarm&, const PTHarm&);
    PtrPointTransform interpPointTrans(double x, const PtrPointTransform, const PtrPointTransform);
    
/* Class of toy maps that combines point trans with isochrone HJ map
 */
    class ToyMapIso:public BaseToyMap{
	    private:
     ...
     * HO HJ map
     */
    class ToyMapHarm:public BaseToyMap{
	private:
		PtrPointTransform PtrPT;
	public:
		HarmonicOscillator HOs;
		PTHarm PT;
		ToyMapHarm() {}
		ToyMapHarm(HarmonicOscillator _HOs, PTHarm _PT) : HOs(_HOs),PT(_PT){
    ...
    PtrToyMap interpPtrToyMap(double, const PtrToyMap&, const PtrToyMap&);
    /*
