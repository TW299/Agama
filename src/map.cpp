...
namespace actions{
    ...
    PtrPointTransform interpPointTrans(double x, const PtrPointTransform PT0, const PtrPointTransform PT1) {
	...
	PtrToyMap interpPtrToyMap(double x, const PtrToyMap& PtrTM0, const PtrToyMap& PtrTM1) {
