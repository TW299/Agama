...
class PerfectEllipsoidTriaxial;
class PhaseVolume;
...
/// shared pointer to an instance of PerfectEllipsoidTriaxial potential
typedef shared_ptr<const PerfectEllipsoidTriaxial> PtrPerfectEllipsoidTriaxial;
