...
namespace actions {
	...
	*/
	...
	PerturbingHamiltonian interpPerturbingHamiltonian(const double x,
	...
	*/
	...
	class ActionFinderTG : public BaseActionFinder {
	private:
	...
	/*void getGridBoxLoop(const potential::BasePotential& pot,
				std::vector<double>& gridE,
				std::vector<double>& gridJr,
				std::vector<double>& gridJz);
	std::vector<double> mapJcrit(const potential::BasePotential& pot);
	//*/
}//namespace actions