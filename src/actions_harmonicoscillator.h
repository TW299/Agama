...
namespace actions {
	...
	public:
		...
		double PE(coord::PosCyl& rp) const { return .5 * (pow_2(omegaR * rp.R) + pow_2(omegaz * rp.z)); }
	...
	HarmonicOscillator interpHarmonicOscillator(const double, const HarmonicOscillator&, const HarmonicOscillator&);
}